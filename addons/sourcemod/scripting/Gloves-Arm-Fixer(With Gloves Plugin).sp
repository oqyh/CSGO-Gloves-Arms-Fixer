...
{
	name = "[CSGO] Arm/Gloves Fixer (With Gloves Plugin)",
	author = "Gold KingZ ",
...
{
	CreateConVar("agf_version", PLUGIN_VERSION, "[ANY] Arm Gloves Fixer(With Gloves Plugin) Plugin Version", FCVAR_NOTIFY|FCVAR_DONTRECORD);

	g_enable = CreateConVar("agf_enable_plugin", "1", "Arm Gloves Fixer(With Gloves Plugin)?\n1= Enable \n0= Disable", _, true, 0.0, true, 1.0);
	...
	AutoExecConfig(true, "Gloves-Arm-Fixer_With-Gloves-Plugin");
